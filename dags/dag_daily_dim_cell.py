...
def fetch_cell_sftp_to_landing(**kwargs):
    ...
    minio_bucket = Variable.get("minio_landing_bucket", default_var="bronze")
...
# =================================================================
# CẤU HÌNH DAG ĐÃ SỬA ĐỂ CHẠY NGAY LẬP TỨC
# =================================================================
default_args = {
    'owner': 'data_engineer_team',
    'depends_on_past': False,
    'start_date': datetime(2024, 1, 1), # Sửa về năm 2024 để quá khứ, không bị kẹt start_date
    'retries': 1,
...
with DAG(
    ...
    description='Kéo và cập nhật (SCD1) bảng Dim Cell (Chạy thủ công)',
    schedule_interval=None, # Đổi thành None để bác tự bấm nút Trigger là chạy luôn
    catchup=False, 
    max_active_runs=1,
    tags=['cell', 'scd1', 'manual']
) as dag:
